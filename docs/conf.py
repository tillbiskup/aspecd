...
latex_documents = [
    (master_doc, 'ASpecD.tex', 'ASpecD Documentation',
     'Till Biskup', 'manual'),
]
...
man_pages = [
    (master_doc, 'aspecd', 'ASpecD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ASpecD', 'ASpecD Documentation',
     author, 'ASpecD', 'One line description of project.',
     'Miscellaneous'),
]
